...
var topics = ["Porsche", "BMW", "Tesla", "Porsche"];
var response;
...
//When the user clicks on a button, the page should grab 10 static, non-animated gif images from the GIPHY API and place them on the page.
        ...
        $("button").on("click", function() {
          ...
          var queryURL = "https://api.giphy.com/v1/gifs/trending?q=" + gif + "&api_key=glo3Suv6j1x7pl2Y2A1ITmD4QnryJQ3i&l&rating=pg-13&limit=5";
