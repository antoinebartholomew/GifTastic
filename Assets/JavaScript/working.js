...
var response;
  ...
  function displayCarInfo() {
    ...
    //var queryURL = "https://api.giphy.com/v1/gifs/trending?q=fast+Car&api_key=glo3Suv6j1x7pl2Y2A1ITmD4QnryJQ3i&l&rating=pg-13&limit=5";
...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        //response is the same as responseData or Data that I see in other examples
...
//Try using a loop that appends a button for each string in the array
        ...
        //Function for displaying movie data...2nd function
